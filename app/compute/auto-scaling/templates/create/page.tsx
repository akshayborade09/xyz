...
const machineImages = [
  {
    ...
    description: 'Latest Ubuntu 20.04 LTS',
  },
  {
    id: 'ami-ubuntu-22.04',
    name: 'Ubuntu 22.04 LTS',
    description: 'Latest Ubuntu 22.04 LTS',
  },
  ...
  { id: 'ami-centos-8', name: 'CentOS 8', description: 'Latest CentOS 8' },
  {
    ...
    description: 'Latest RHEL 7',
  },
  {
    id: 'ami-rhel-8',
    name: 'Red Hat Enterprise Linux 8',
    description: 'Latest RHEL 8',
  },
];
            ...
            <Card>
              <CardContent className='space-y-6 pt-6'>
                  ...
                  <div className='space-y-2'>
                    ...
                    >
                      <SelectTrigger>
                        <SelectValue
                          placeholder={
                            formData.vpc ? 'Select subnet' : 'Select VPC first'
                          }
                        />
                      </SelectTrigger>
                      <SelectContent>
                  ...
                  <div className='space-y-2'>
                    ...
                    <div className='border border-gray-200 rounded-lg p-4 min-h-[100px] flex items-center justify-center'>
                      <div className='text-center text-muted-foreground'>
                        ...
                        <p className='text-xs'>
                          Security groups will be inherited from the VPC
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <StorageSection
                  ...
                  onUpdateBootVolumeName={value =>
                    handleInputChange('bootVolumeName', value)
                  }
                  onUpdateBootVolumeSize={value =>
                    handleInputChange('bootVolumeSize', value)
                  }
                  onUpdateMachineImage={value =>
                    handleInputChange('machineImage', value)
                  }
                ...
                <ScriptsTagsSection
                  ...
                  onUpdateStartupScript={value =>
                    handleInputChange('startupScript', value)
                  }
                ...
                <ul className='space-y-3'>
                  ...
                  <li className='flex items-start gap-2'>
                    ...
                    <span
                      ...
                      style={{ fontSize: '13px' }}
                    >
                      Configure standardized instance types and storage
                      configurations.
                    </span>
                  </li>
                  <li className='flex items-start gap-2'>
                    ...
                    <span
                      ...
                      style={{ fontSize: '13px' }}
                    >
                      Use tags to categorize templates by environment, team, or
                      project.
                    </span>
                  </li>
                  <li className='flex items-start gap-2'>
                    ...
                    <span
                      ...
                      style={{ fontSize: '13px' }}
                    >
                      Test templates thoroughly before making them available to
                      teams.
                    </span>
                  </li>
                </ul>
            ...
            >
              ...
              <div className='space-y-3'>
                ...
                <div className='text-xs text-muted-foreground pt-2 border-t'>
                  <p>
                    • Instance Type: {formData.instanceType || 'Not selected'}
                  </p>
                  <p>
                    • Storage: {formData.bootVolumeSize}GB +{' '}
                  ...
                  <p>
                    • Policies: {formData.scalingPolicies.length} configured
                  </p>
