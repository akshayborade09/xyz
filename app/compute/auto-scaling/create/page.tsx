...
export default function CreateAutoScalingGroupPage() {
  ...
  const isFormValid = () => {
    return (
      formData.asgName.trim().length > 0 &&
  ...
  const removeTag = (index: number) => {
    setFormData(prev => {
      ...
      return {
        ...prev,
        tags: newTags.length > 0 ? newTags : [{ key: '', value: '' }],
      };
    });
  };
  ...
  const vpcOptions = [
    {
      value: 'vpc-main-prod',
      label: 'vpc-main-prod',
      subnets: ['hyderabad-1a-public', 'hyderabad-1b-private'],
    },
    {
      value: 'vpc-staging',
      label: 'vpc-staging',
      subnets: ['hyderabad-staging-public', 'hyderabad-staging-private'],
    },
    {
      value: 'vpc-dev',
      label: 'vpc-dev',
      subnets: ['hyderabad-dev-public', 'hyderabad-dev-private'],
    },
  ];
          ...
          <Card>
            <CardContent className='space-y-6 pt-6'>
              ...
              <div className='space-y-4'>
                ...
                <div className='space-y-3'>
                  ...
                  <RadioGroup
                    ...
                    onValueChange={(value: 'scratch' | 'template') =>
                      handleInputChange('creationMode', value)
                    }
                ...
                {formData.creationMode === 'template' && (
                  <div className='space-y-2'>
                    ...
                    <Select
                      ...
                      onValueChange={value =>
                        handleInputChange('selectedTemplate', value)
                      }
                    >
                      <SelectTrigger>
              ...
              <div className='space-y-4'>
                  ...
                  <div className='space-y-2'>
                    ...
                    <div className='relative' ref={vpcSelectorRef}>
                      ...
                      >
                        <span
                          className={
                            selectedVPC ? 'text-foreground' : '!text-[#64748b]'
                          }
                        >
                          {selectedVPC
                ...
                <div className='space-y-2'>
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      handleInputChange('subnets', [value])
                    }
                  ...
                  >
                    <SelectTrigger>
                      <SelectValue
                        placeholder={
                          formData.vpc ? 'Select VPC first' : 'Select VPC first'
                        }
                      />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  ...
                  <div className='space-y-2'>
                    ...
                    <Select
                      ...
                      onValueChange={value =>
                        handleInputChange('instanceType', value)
                      }
                    >
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  <p className='text-sm text-muted-foreground mt-1'>
                    Configure the minimum, desired, and maximum number of
                    instances for your Auto Scaling Group.
                  </p>
                </div>
                <div className='grid grid-cols-3 gap-4'>
                  ...
                  <div className='space-y-2'>
                    ...
                    />
                    <p className='text-xs text-muted-foreground'>
                      Initial number of instances to launch
                    </p>
                  </div>
                  <div className='space-y-2'>
              ...
              <StorageSection
                ...
                onUpdateBootVolumeName={name =>
                  handleInputChange('bootVolumeName', name)
                }
                onUpdateBootVolumeSize={size =>
                  handleInputChange('bootVolumeSize', size)
                }
                onUpdateMachineImage={image =>
                  handleInputChange('machineImage', image)
                }
              ...
              <ScriptsTagsSection
                ...
                onUpdateStartupScript={script =>
                  handleInputChange('startupScript', script)
                }
                onAddTag={addTag}
              ...
              <div className='flex items-center space-x-2'>
                <Checkbox
                  ...
                  onCheckedChange={checked =>
                    handleInputChange('saveAsTemplate', checked)
                  }
                />
              ...
              <ul className='space-y-3'>
                ...
                <li className='flex items-start gap-2'>
                  ...
                  <span
                    ...
                    style={{ fontSize: '13px' }}
                  >
                    Set up both scale-out and scale-in policies based on CPU and
                    memory metrics.
                  </span>
                </li>
                <li className='flex items-start gap-2'>
                  ...
                  <span
                    ...
                    style={{ fontSize: '13px' }}
                  >
                    Configure health checks to automatically replace unhealthy
                    instances.
                  </span>
                </li>
                <li className='flex items-start gap-2'>
                  ...
                  <span
                    ...
                    style={{ fontSize: '13px' }}
                  >
                    Use launch templates to standardize instance configurations
            ...
            <div className='space-y-3'>
              <div className='flex items-baseline gap-2'>
                <span className='text-2xl font-bold'>
                  ₹
                  {(
                    (instanceTypes.find(t => t.id === formData.instanceType)
                      ?.pricePerHour || 0) *
                    formData.desiredInstances *
                    72
                  ).toFixed(2)}
                </span>
              ...
              <p className='text-sm text-muted-foreground'>
                Auto Scaling Group with {formData.desiredInstances}{' '}
                {formData.instanceType || 'instance'} instances.
              </p>
              <div className='text-xs text-muted-foreground pt-2 border-t'>
                ...
                <p>
                  • Storage: ₹
                  {(
                    (formData.bootVolumeSize +
                      formData.storageVolumes.reduce(
                        (sum, vol) => sum + vol.size,
                        0
                      )) *
                    0.1 *
                    formData.desiredInstances
