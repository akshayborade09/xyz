...
interface ScalingPoliciesSectionProps {
  ...
  onUpdateScalingPolicy: (
    id: string,
    field: keyof Omit<ScalingPolicy, 'id'>,
    value: any
  ) => void;
    ...
    <div className='space-y-4'>
      <div>
        ...
        <p className='text-sm text-muted-foreground mt-1'>
          Configure auto-scaling policies for CPU, memory, and scheduled
          actions. You can have one policy of each type (CPU, Memory,
          Scheduled).
        </p>
      </div>
      <div>
        {scalingPolicies.length === 0 ? (
          <div className='flex flex-col items-center justify-center py-8 border border-gray-200 rounded-lg bg-gray-50'>
            ...
            <p className='text-sm text-muted-foreground text-center mb-4'>
              No auto-scaling policies configured yet. Add your first policy to
