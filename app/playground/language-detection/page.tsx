...
import { LanguageDetectionPlayground } from '@/components/playground/language-detection-playground';
...
export default function LanguageDetectionPage() {
  ...
  const [selectedModel, setSelectedModel] = useState('language-detection');
  const model = modelData['language-detection'];
  ...
  useEffect(() => {
    setSelectedModel('language-detection');
  }, []);
