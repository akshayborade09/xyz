...
import { SentimentAnalysisPlayground } from '@/components/playground/sentiment-analysis-playground';
...
export default function SentimentAnalysisPage() {
  ...
  const model = modelData['sentiment-analysis'];
  ...
  useEffect(() => {
    setSelectedModel('sentiment-analysis');
  }, []);
