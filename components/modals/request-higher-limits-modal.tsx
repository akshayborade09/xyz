...
export function RequestHigherLimitsModal({
  open,
  onClose,
}: RequestHigherLimitsModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          'Your request for higher node scaling limits has been submitted. Our team will review it and get back to you within 24 hours.',
      });
