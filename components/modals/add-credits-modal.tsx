...
export function AddCreditsModal({ open, onClose, onCreditsUpdated }: AddCreditsModalProps) {
  const { toast } = useToast();
  const { updateCredits, credits } = useUserCredits();
  ...
  const handlePurchase = async () => {
    if (!customAmount || orderSummary.credits <= 0) {
      toast({
    ...
    // Update credits
    const newCredits = credits + orderSummary.credits;
    ...
    toast({
      ...
      description: `${orderSummary.credits} credits have been added to your account`,
    });
    ...
    <>
            ...
            <Card>
                  ...
                  <div className='flex items-start gap-3 py-2'>
                    ...
                    <div className='flex-1'>
                      <div className='font-medium'>
                        Krutrim Cloud Credits - {orderSummary.credits} Credits
                      </div>
              ...
              <CardFooter className='flex justify-end gap-2 px-6'>
                ...
                <Button 
                  ...
                  disabled={isProcessing || !customAmount || orderSummary.credits <= 0}
                >
      ...
      <Dialog open={editAddress} onOpenChange={setEditAddress}>
        <DialogContent>
          ...
          <DialogFooterUI>
            <Button variant='outline' onClick={() => setEditAddress(false)}>
              Cancel
            </Button>
            <Button variant='default' onClick={() => setEditAddress(false)}>
              Save
            </Button>
          </DialogFooterUI>
        </DialogContent>
