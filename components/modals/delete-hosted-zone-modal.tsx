...
export function DeleteHostedZoneModal({
  ...
  const handlePaste = (e: React.ClipboardEvent) => {
    ...
    toast({
      ...
      description:
        'For security reasons, you must type the domain name manually.',
      variant: 'destructive',
    });
  };
      ...
      >
        <DialogHeader className='space-y-3 pb-4'>
          ...
          <DialogDescription className='text-sm text-muted-foreground leading-relaxed'>
            This {hostedZone.type.toLowerCase()} hosted zone has{' '}
            {hostedZone.recordCount} DNS record
            {hostedZone.recordCount !== 1 ? 's' : ''}. Are you sure you want to
            delete it?
          </DialogDescription>
        </DialogHeader>
        ...
        <div className='space-y-6 py-2'>
          ...
          <Alert variant='destructive'>
            ...
            <AlertDescription>
              <strong>Warning:</strong> This will permanently delete hosted zone
              "{hostedZone.domainName}" and all its DNS records. This action
              cannot be undone.
            </AlertDescription>
          </Alert>
        </div>
