...
export function AddPolicyModal({
  ...
  const [incremental, setIncremental] = useState(
    initialPolicy?.incremental || false
  );
      ...
      <DialogContent className='p-0 bg-white max-w-[60vw] max-h-[85vh] w-[60vw] h-[85vh] overflow-hidden flex flex-col'>
        <DialogHeader className='flex-shrink-0 p-6 border-b'>
          <DialogTitle className='text-2xl font-semibold'>
            {mode === 'add'
              ? `Create ${type === 'snapshot' ? 'Snapshot' : 'Backup'} Policy`
              : `Edit ${type === 'snapshot' ? 'Snapshot' : 'Backup'} Policy`}
          </DialogTitle>
        </DialogHeader>
        ...
        <div className='flex-1 flex gap-6 min-h-0 p-6'>
          ...
          >
            <form onSubmit={handleSubmit} ref={formRef} className='space-y-6'>
              ...
              <div>
                <div className='flex items-center gap-2 mb-2'>
                  <Label className='font-medium'>Incremental Backup</Label>
                  <TooltipWrapper
                ...
                <div className='flex items-center space-x-2'>
                  ...
                  >
                    <span
                      className={`block w-6 h-6 rounded-full bg-white shadow transform transition-transform duration-200 ${incremental ? 'translate-x-6' : ''}`}
                    ></span>
                  </button>
              ...
              <div>
                ...
                <div className='text-sm text-muted-foreground mb-4'>
                  Leave fields empty for "any" value, or fill in specific values
                  to create constraints. All specified constraints must be met.
                </div>
                ...
                <div className='bg-blue-50 p-3 rounded-lg mt-4'>
                  ...
                  <div className='text-xs space-y-1 text-muted-foreground'>
                    ...
                    <div>
                      • <strong>Daily at 2:30 AM:</strong> Minute: 30, Hour: 2,
                      leave others empty
                    </div>
                    <div>
                    ...
                    <div>
                      • <strong>Monthly on 1st at midnight:</strong> Minute: 0,
                      Hour: 0, Day: 1
                    </div>
                  </div>
                </div>
