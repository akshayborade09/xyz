  ...
  return (
    <>
      <style jsx>{`
        ...
        .glow-container {
          --card-color: hsl(220deg 13% 9%);
          --text-color: hsl(220deg 9% 46%);
          --card-radius: 12px;
          --card-width: 100%;
          --border-width: 1px;
          --bg-size: 1;
        ...
        .glow-content:before {
          ...
          z-index: -1;
          background: hsl(220deg 13% 9%) radial-gradient(
        ...
        .glow-container:hover .glow-content {
          ...
          --text-color: white;
          box-shadow: 0 0 calc(var(--white-shadow) * 4px) calc(var(--white-shadow) * 1px) rgb(255 255 255 / 20%);
